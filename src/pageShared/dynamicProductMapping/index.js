...
import { modifyMapData, modifySubMappedData, removeHighestSlNo } from './function';

class DynamicProductMapping extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            mapData: [],
    ...
    // for initial call
    _load = async () => {
        let locationData = removeHighestSlNo(await StorageDataModification.locationMappedDataProduct({}, "get"));
...
export default DynamicProductMapping;