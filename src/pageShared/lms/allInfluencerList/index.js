...
class AllInfluencerList extends Component {
    ...
    _apiCallRes = async () => {
        ...
        if (this.props.Sales360Redux.routeData.hierarchyTypeId && this.props.Sales360Redux.routeData.hierarchyDataId) {
            let dataReq = {
                ...
                "searchName": this.props.requestData.searchText,
                "searchTextCustName": "",
                "searchTextCustType": "",
                "searchTextCustPhone": "",
    ...
    activePointSec = () => {
        return (
            <React.Fragment>
                <View style={{ borderselectedCustomerObjWidth: 1, borderRadius: 30, borderColor: "#839CAE", alignSelf: "flex-start", alignItems: "center", flexDirection: "row", paddingHorizontal: 10, paddingVertical: 5 }}>
...
export default connect(mapStateToProps, mapDispatchToProps)(AllInfluencerList);
