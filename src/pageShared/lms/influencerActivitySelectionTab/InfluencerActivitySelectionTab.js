...
const dayDataArr = [
    ...
    </svg>`, "iconBgColor": null, "isDisable": false, "labelName": "Previous Reffered", "labelNameColor": "#FFFFFF", "name": "Customer", "nameColor": "#FFFFFF", "routeName": "InfluencerNewCustomer"
    },
    {
    ...
    </svg>`, "iconBgColor": null, "isDisable": false, "labelName": "Transaction", "labelNameColor": "#FFFFFF", "name": "Passsbook", "nameColor": "#FFFFFF", "routeName": "InfluencerPassbookAndRedemption"
    }, {
    ...
    </svg>`, "iconBgColor": null, "isDisable": false, "labelName": "Active", "labelNameColor": "#FFFFFF", "name": "Catalogue", "nameColor": "#FFFFFF", "routeName": "InfluencerCatalogue"
    }]


class InfluencerActivitySelectionTab extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dayData: dayDataArr,
    ...
    selectItem = async (itemData, key) => {
        ...
        if (itemData.routeName && itemData.routeName.length > 0) {
            this.props.navigation.navigate(itemData.routeName, { propData: this.props.route.params.propData, type: "customer" });
        }
        this.setState(this.state);
    ...
    onViewDesign = () => {
        ...
        for (let i = 0; i < this.state.dayData.length; i++) {
            ...
            respDesign.push(
                <TouchableOpacity disabled={isDisable} onPress={() => this.selectItem(itemData, i)} style={{
                    width: Dimension.width / 3, alignItems: 'center', backgroundColor: backgroundColor, borderRadius: 10, marginRight: 10, paddingVertical: 15,
...
export default InfluencerActivitySelectionTab;