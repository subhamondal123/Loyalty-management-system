                                            ...
                                            <View style={{ flexDirection: "row" }}>
                                                ...
                                                <View>
                                                    <View style={{ alignItems: 'flex-end' }}>
                                                        <Text style={{ color: "#747C90", fontFamily: FontFamily.FONTS.POPPINS.MEDIUM, fontSize: 10 }}>Act. Lifting Date</Text>
                                                        <Text style={{ color: Color.COLOR.BLUE.LOTUS_BLUE, fontFamily: FontFamily.FONTS.POPPINS.MEDIUM, fontSize: 10, top: -4 }}>{DateConvert.getDayMonthYearName(item.salesDate)}</Text>
                                                    </View>
                                                    <View style={{ alignItems: 'flex-end' }}>
