...
class InfluencerCatalogueItemDetails extends Component {
    constructor(props) {
        super(props)
    ...
    suggestedProductSec = () => {
        ...
        const onSelectItem = (item) => {
            ...
            this.props.navigation.navigate("GlobalCatalogueItemDetails", { data: propItem, propData: this.state.propData })
        }
        return (
...
export default connect(mapStateToProps, mapDispatchToProps)(InfluencerCatalogueItemDetails);