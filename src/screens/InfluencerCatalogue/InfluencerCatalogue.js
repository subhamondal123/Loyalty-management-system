...
class InfluencerCatalogue extends Component {
    constructor(props) {
        super(props)
    ...
    setInitialData = async () => {
        this.setState({
            profileSecLoader: true
        })
    }

    load = async () => {
        await this.getCatalogueByLocation()
        this.setState({ pageLoader: false, refreshing: false, profileSecLoader: false })
    ...
    listSec = () => {
        const onSelectItem = (item) => {
            ...
            this.props.navigation.navigate("InfluencerCatalogueItemDetails", { data: propItem, propData: this.state.propData })
        }
        ...
        return (
            <SafeAreaView style={styles.container}>
                ...
                <View style={{ marginTop: 5 }}>
                    <ProfileSec props={this.props} isRefresh={this.state.profileSecLoader} />
...
export default connect(mapStateToProps, mapDispatchToProps)(InfluencerCatalogue);